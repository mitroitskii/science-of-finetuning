...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-samples", type=int, default=100_000_000) # defines the total number of tokens in the combined dataset the crosscoder is trained on
    ...
    parser.add_argument("--max-steps", type=int, default=None)  # max steps to train crosscoder for, by default is len of dataset // batch_size
    ...
    parser.add_argument("--run-name", type=str, default=None) # defines a name of the run in wandb
    ...
    fineweb_cache_val, lmsys_cache_val = load_activation_dataset( 
        ...
        lmsys_name="OpenR1-Math-220k-formatted",
        fineweb_name="fineweb-1m-sample",
        lmsys_split="test" + lmsys_split_suffix,
